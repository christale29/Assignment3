...
public class StudentRegistration {
    ...
    public StudentRegistration(int regid, String regDate, Student student, Semester sem, AcademicUnit unit, List<Course> courses) {
        this.regid = regid;
    ...
    public StudentRegistration(String regDate, Student student, Semester sem, AcademicUnit unit, List<Course> courses) {
        this.regDate = regDate;
        this.student = student;
        this.sem = sem;
        this.unit = unit;
